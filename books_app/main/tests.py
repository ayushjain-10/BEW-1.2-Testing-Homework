...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        # TODO: Crate a user & login (so that the user can access the route)
        create_user()
        login(self.app, 'me1', 'password')
        ...
        author_data = {
            'name': 'J.K. Rowling',
            'books': 'HP',
            'biography': 'J.K. Rowling is a British author, screenwriter, '
        }
    ...
    def test_profile_page(self):
        """ Test that the user info shows up on the profile page """
        create_user()
        # Make a GET request
